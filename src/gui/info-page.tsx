...
export function InfoPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <Card>
        <h3 className="text-base font-semibold text-gray-900 mb-2">Saving your work</h3>
        <p className="text-sm text-gray-700 mb-3">
          Nothing is stored in your browser. Closing the tab loses everything
          that has not been exported.
        </p>
        <ul className="text-sm text-gray-700 list-disc pl-5 space-y-1">
          <li><strong>Export</strong> downloads your whole state — the workout you are editing and the entire library — as a single file.</li>
          <li><strong>Import</strong> reads one back, replacing everything currently open.</li>
          <li>Turn on &ldquo;Ask where to save each file&rdquo; in your browser if you want to overwrite the same file each time instead of collecting copies in Downloads.</li>
        </ul>
      </Card>
